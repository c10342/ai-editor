  ...
  return {
    ...
    renderToolbar(editorManager) {
      ...
      const items: Array<{ labelKey: string; icon?: string; action: () => void }> = [
        ...
        {
          labelKey: 'toolbar.table.addColBefore',
        ...
        {
          labelKey: 'toolbar.table.addColAfter',
        ...
        {
          labelKey: 'toolbar.table.deleteCol',
          icon: 'delete-column',
          action: () => {
        ...
        {
          labelKey: 'toolbar.table.addRowBefore',
          icon: 'add-row-before',
          action: () => {
        ...
        {
          labelKey: 'toolbar.table.addRowAfter',
          icon: 'add-row-after',
          action: () => {
        ...
        {
          labelKey: 'toolbar.table.deleteRow',
          icon: 'delete-row',
          action: () => {
        ...
        {
          labelKey: 'toolbar.table.mergeCells',
          icon: 'merge-cells',
          action: () => {
        ...
        {
          labelKey: 'toolbar.table.splitCell',
          icon: 'split-cell',
          action: () => {
        ...
        {
          labelKey: 'toolbar.table.deleteTable',
          icon: 'delete-table',
          action: () => {
